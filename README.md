...
1. Full source-code to offline MAGPIE build to test and explore on a Linux operating system
2. Full source-code to a Raspberry PI 3 validated build to install with dpkg requirements on Raspberry PI
